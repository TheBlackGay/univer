(() => {
  ...
  var Stacktrace = class _Stacktrace {
    static create() {
      var _a6;
      const err = new Error();
      return new _Stacktrace((_a6 = err.stack) != null ? _a6 : "");
    }
    constructor(value) {
      this.value = value;
    }
  ...
  var Emitter = class {
    constructor(options) {
      ...
      this._leakageMon = _globalLeakWarningThreshold > 0 || ((_a6 = this._options) == null ? void 0 : _a6.leakWarningThreshold) ? new LeakageMonitor((_b2 = options == null ? void 0 : options.onListenerError) != null ? _b2 : onUnexpectedError, (_d = (_c = this._options) == null ? void 0 : _c.leakWarningThreshold) != null ? _d : _globalLeakWarningThreshold) : void 0;
    ...
    get event() {
      var _a6;
      (_a6 = this._event) != null ? _a6 : this._event = (callback, thisArgs, disposables) => {
        var _a7, _b2, _c, _d, _e, _f, _g, _h;
        if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
          const message = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`;
          console.warn(message);
          const tuple = (_a7 = this._leakageMon.getMostFrequentStack()) != null ? _a7 : ["UNKNOWN stack", -1];
          const error = new ListenerRefusalError(`${message}. HINT: Stack shows most frequent listener (${tuple[1]}-times)`, tuple[0]);
          const errorHandler2 = ((_b2 = this._options) == null ? void 0 : _b2.onListenerError) || onUnexpectedError;
          errorHandler2(error);
  ...
  var _a2;
  var isElectronProcess = typeof ((_a2 = nodeProcess == null ? void 0 : nodeProcess.versions) == null ? void 0 : _a2.electron) === "string";
  var isElectronRenderer = isElectronProcess && (nodeProcess == null ? void 0 : nodeProcess.type) === "renderer";
  var _a3;
  ...
  var URI = class _URI {
    ...
    static revive(data) {
      ...
      if (!data) {
        ...
        result._formatted = (_a6 = data.external) != null ? _a6 : null;
        result._fsPath = data._sep === _pathSepMarker ? (_b2 = data.fsPath) != null ? _b2 : null : null;
        return result;
      }
    }
  };
  ...
  var _LineRangeFragment = class _LineRangeFragment {
    ...
    computeSimilarity(other) {
      ...
      for (let i = 0; i < maxLength; i++) {
        sumDifferences += Math.abs(((_a6 = this.histogram[i]) != null ? _a6 : 0) - ((_b2 = other.histogram[i]) != null ? _b2 : 0));
      }
  ...
  var LinesSliceCharSequence = class {
    ...
    extendToFullLines(range) {
      var _a6, _b2;
      const start = (_a6 = findLastMonotonous(this.firstElementOffsetByLineIdx, (x) => x <= range.start)) != null ? _a6 : 0;
      const end = (_b2 = findFirstMonotonous(this.firstElementOffsetByLineIdx, (x) => range.endExclusive <= x)) != null ? _b2 : this.elements.length;
      return new OffsetRange(start, end);
    }
  };
  ...
  function format(documentText, range, options) {
    ...
    if (options.insertSpaces) {
      indentValue = (_a6 = cachedSpaces[options.tabSize || 4]) != null ? _a6 : repeat(cachedSpaces[1], options.tabSize || 4);
    } else {
      indentValue = "	";
    }
  ...
  function t(...args) {
    ...
    if (typeof firstArg === "string") {
      ...
      formatArgs = (_a6 = firstArg.args) != null ? _a6 : {};
    }
  ...
  function format3(template, values) {
    ...
    return template.replace(_format2Regexp, (match, group) => {
      var _a6;
      return (_a6 = values[group]) != null ? _a6 : match;
    });
  }
  var formats = {
    ...
    validate(textDocument, schema, severity = DiagnosticSeverity.Warning, schemaDraft) {
      if (this.root && schema) {
        ...
        return validationResult.problems.map((p) => {
          ...
          return Diagnostic.create(range, p.message, (_a6 = p.severity) != null ? _a6 : severity, p.code);
        });
      }
      return void 0;
    }
  ...
  function getSchemaDraft(schema, fallBack = SchemaDraft.v2020_12) {
    ...
    if (schemaId) {
      return (_a6 = schemaDraftFromId[schemaId]) != null ? _a6 : fallBack;
    }
    return fallBack;
  }
  function validate(n, schema, validationResult, matchingSchemas, context) {
    ...
    function _validateNode() {
      ...
      if (deprecationMessage || schema.deprecated) {
        ...
        let targetNode = ((_a6 = node.parent) == null ? void 0 : _a6.type) === "property" ? node.parent : node;
        validationResult.problems.push({
    ...
    function _validateNumberNode(node2) {
      ...
      function normalizeFloats(float) {
        ...
        return parts && {
          ...
          multiplier: (((_a6 = parts[2]) == null ? void 0 : _a6.length) || 0) - (parseInt(parts[3]) || 0)
        };
      }
      ;
  ...
  var JSONCompletion = class {
    ...
    doesSupportMarkdown() {
      ...
      if (!isDefined(this.supportsMarkdown)) {
        const documentationFormat = (_c = (_b2 = (_a6 = this.clientCapabilities.textDocument) == null ? void 0 : _a6.completion) == null ? void 0 : _b2.completionItem) == null ? void 0 : _c.documentationFormat;
    ...
    doesSupportsCommitCharacters() {
      ...
      if (!isDefined(this.supportsCommitCharacters)) {
        this.labelDetailsSupport = (_c = (_b2 = (_a6 = this.clientCapabilities.textDocument) == null ? void 0 : _a6.completion) == null ? void 0 : _b2.completionItem) == null ? void 0 : _c.commitCharactersSupport;
      }
    ...
    doesSupportsLabelDetails() {
      ...
      if (!isDefined(this.labelDetailsSupport)) {
        this.labelDetailsSupport = (_c = (_b2 = (_a6 = this.clientCapabilities.textDocument) == null ? void 0 : _a6.completion) == null ? void 0 : _b2.completionItem) == null ? void 0 : _c.labelDetailsSupport;
      }
  ...
  var JSONSchemaService = class {
    ...
    getSchemaFromProperty(resource, document2) {
      var _a6, _b2;
      if (((_a6 = document2.root) == null ? void 0 : _a6.type) === "object") {
  ...
  function findLinks(document2, doc) {
    ...
    doc.visit((node) => {
      var _a6;
      if (node.type === "property" && node.keyNode.value === "$ref" && ((_a6 = node.valueNode) == null ? void 0 : _a6.type) === "string") {
  ...
  function getLanguageService(params) {
    ...
    return {
      configure: (settings) => {
        ...
        (_a6 = settings.schemas) == null ? void 0 : _a6.forEach(jsonSchemaService.registerExternalSchema.bind(jsonSchemaService));
